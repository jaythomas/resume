...
\setupcolor[hex]
\definecolor[titlegrey][h=2d7cc2]
\definecolor[sectioncolor][h=2d7cc2]
\definecolor[rulecolor][h=4290d6]
...
\setuphead[subsubsection][style=\bf, color=titlegrey, font=10pt, before=]
